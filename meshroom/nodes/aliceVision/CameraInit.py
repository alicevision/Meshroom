...
Intrinsic = [
    ...
    desc.ChoiceParam(name="type", label="Camera Type",
                     ...
                     value="", values=['', 'pinhole', 'radial1', 'radial3', 'brown', 'fisheye4', 'equidistant_r3', 'anamorphic4', 'anamorphic10', 'radial3de'], exclusive=True, uid=[0]),
...
'''
    ...
    inputs = [
        ...
        desc.ChoiceParam(
            ...
            value=['pinhole', 'radial1', 'radial3', 'brown', 'fisheye4', 'fisheye1', 'anamorphic4', 'anamorphic10', 'radial3de'],
            values=['pinhole', 'radial1', 'radial3', 'brown', 'fisheye4', 'fisheye1', 'anamorphic4', 'anamorphic10', 'radial3de'],
            exclusive=False,
            uid=[],
            joinChar=',',
            advanced=True,
