...
class FeatureMatching(desc.CommandLineNode):
    ...
    inputs = [
        ...
        desc.ChoiceParam(
            ...
            description='Pairwise correspondences filtering thanks to robust model estimation: (fundamental_matrix, essential_matrix, homography_matrix)',
            value=['fundamental_matrix'],
            values=['fundamental_matrix', 'essential_matrix', 'homography_matrix'],
            exclusive=False,
            uid=[0],
            joinChar=',',
        ),
