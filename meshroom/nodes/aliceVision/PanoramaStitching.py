...
class PanoramaStitching(desc.CommandLineNode):
    ...
    inputs = [
        ...
        desc.BoolParam(
         ...
         desc.IntParam(
             name='debugSubsetStart',
             label='Debug: Start Index of SubSet',
             description='Start index of subset images to merge.',
             value=0,
             range=(0, 80, 1),
             uid=[0],
             advanced=True,
         ...
         desc.IntParam(
             name='debugSubsetSize',
             label='Debug: Nb Images in SubSet',
             description='Number of images in subset to merge.',
             value=0,
             range=(0, 80, 1),
             uid=[0],
             advanced=True,
