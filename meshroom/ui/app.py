...
class MeshroomApp(QApplication):
    ...
    def __init__(self, inputArgs):
        ...
        self.engine.rootContext().setContextProperty("_nodeTypes", {n: {"category": pluginManager.getNodeDescProviders()[n].nodeDescriptor.category} for n in sorted(pluginManager.getNodeDescProviders().keys())})
