...
def registerTypes():
    ...
    from meshroom.ui.components.scene3D import Scene3DHelper, TurntableCameraController, Transformations3DHelper
    ...
    qmlRegisterType(TurntableCameraController, "Meshroom.Helpers", 1, 0, "TurntableCameraController")
