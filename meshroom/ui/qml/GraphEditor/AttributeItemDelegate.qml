    ...
    Loader {
        ...
        sourceComponent: {
            ...
            switch (attribute.type) {
                ...
                default:
                    // All scalar attribute types (PushButtonParam, ChoiceParam, IntParam, FloatParam,
                    // BoolParam, StringParam, ColorParam, ...) share their editor with table cells.
        ...
        Component {
            ...
            AttributeControls.AttributeValueEditor {
