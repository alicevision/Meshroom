...
Rectangle {
    ...
    QtObject {
        ...
        function removeOne(id) {
            currentJob.images.removeResource(currentJob.images.get(id).modelData);
        }
    }
    ...
    TabView {
        ...
        Tab {
            ...
            GridGallery { visualModel: imageModel }
        }
        Tab {
            title: "List"
            property string iconSource: "qrc:///images/diaporama.svg"
            ListGallery { visualModel: imageModel }
        }
        Tab {
            title: "Detail"
            property string iconSource: "qrc:///images/list.svg"
            DetailGallery  { visualModel: imageModel }
        }
    }
